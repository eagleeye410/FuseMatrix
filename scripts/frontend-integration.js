 ...
 * This file demonstrates how to integrate Fusematrix with a web frontend
 */

// For React/Vue/Angular applications
export class FusematrixClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FusematrixClient(provider, contractAddress);
